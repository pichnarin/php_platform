...
<body>
    ...
    <section>
        <div id="carouselExampleCaptions" class="carousel slide mt-2" data-bs-ride="false">
            ...
            $result = $ads->getActiveAds();
            $firstItem = true;
            foreach ($result as $res) {
                ?>
                <div class="carousel-inner">
                    <div class="carousel-item <?php echo $firstItem ? 'active' : ''; ?>">
                        <img src="./assets/img/<?php echo $res['ads_img'] ?>" class="d-block w-100" alt="...">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        ...
                        <img src="./assets/img/dilivery.png" alt="">
                        <h5 class="bg-1">Free Delivery</h5>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        style="visibility: visible;">
                        <img src="./assets/img/online-order.png" alt="">
                        <h5 class="bg-2 bg-info">Online Order</h5>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        style="visibility: visible;">
                        <img src="./assets/img/save-money.png" alt="">
                        <h5 class="bg-3 bg-success">Save money</h5>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        ...
                        <h5 class="bg-6">Discount</h5>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        style="visibility: visible;">
                        <img src="./assets/img/happy-sell.png" alt="">
                        <h5 class="bg-5">Happy Sell</h5>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0" id="pro">
                    <div class="banner-features wow fadeIn animated hover-up animated animated"
                        style="visibility: visible;">
                        <img src="./assets/img/24hsupport.png" alt="">
                        <h5 class="bg-4">24/7 Support</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-2 mt-3">
                    ...
                    <ul id="men" class=" position-relative list-unstyled">
                        <li class="nav-item">
                            <a href="category.php?p1=menClothes" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Men's clothes</a>
                        </li>
                        <li class="nav-item">
                            <a href="category.php?p2=menShoes" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Men shoes</a>
                        </li>
                        <li class="nav-item">
                            <a href="category.php?p3=menWallets" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Men's wallet</a>
                        </li>
                    </ul>
                    ...
                    <ul id="women" class=" position-relative list-unstyled">
                        <li class="nav-item">
                            <a href="category.php?p4=womenClothes" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Women's Clothes</a>
                        </li>
                        <li class="nav-item">
                            <a href="category.php?p5=womenShoes" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Women's shoes</a>
                        </li>
                        <li class="nav-item">
                            <a href="category.php?p6=womenWallets" class="nav-link ml-5 p-2 btn-sm btn-outline-info text-dark">Women's wallets</a>
                        </li>
                    </ul>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                                <div class="product-item bg-light mb-4">
                                    <div class="product-img position-relative overflow-hidden">
                                        <img class="img-fluid w-100" src="./assets/img/<?php echo $res['product_image']; ?>"
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a class="btn btn-outline-info btn-square"
                                                href="./detail.php?p=<?php echo $res['id']; ?>"><i
