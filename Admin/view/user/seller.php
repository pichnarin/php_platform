...
<body>
    <div class="container">
        <h1 style="font-weight: 600; opacity: .8;">Sellers</h1>
    </div>
    ...
    <!-- <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8">
                <a href="index.php?pageSellerAdd=sellerAdd" class="btn btn-success float-right"><i class="fa-solid fa-plus"></i> Add new</a>
            ...
            <tbody>
                ...
                foreach($seller as $data){
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <a href="index.php?pageSellerUpdate=sellerUpdate&&id=<?php echo $data['seller_id']; ?>&&action=Update"
                                    class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a> -->
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal<?php echo $data['seller_id']; ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                                <!-- Modal Popup Delete -->
                                <div class="modal fade" id="deleteModal<?php echo $data['seller_id']; ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="index.php?pageSellerDelete=sellerDelete&&id=<?php echo $data['seller_id']; ?>"
