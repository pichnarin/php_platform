...
<body>
    <div class="container">
        <h1 style="font-weight: 600; opacity: .8;">Admins</h1>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8">
                <a href="index.php?pageAdminAdd=adminAdd" class="btn btn-success float-right"><i class="fa-solid fa-plus"></i> Add new</a>
